                    ...
                    <div className="mb-4 d-flex justify-content-center">
                        {
                            props.activeUser.profilePicture === "Null" ?
                                ...
                                : <img src={props.activeUser.profilePicture} className="rounded-circle avatar-lg img-thumbnail" alt="Quicksliver" />
                        }
                                    ...
                                    <Card className="p-2 mb-2">
                                        <div className="d-flex align-items-center">
                                            <div className="chat-avatar">
                                                ...
                                                <img src={avatar7} className="rounded-circle chat-user-img avatar-xs me-3" alt="Quicksliver" />
                                            </div>
                                            <div>
                                                <div className="text-left">
