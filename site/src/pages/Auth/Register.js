...
//Import Images
import logodark from "../../assets/images/QuicksliverTextDark.png";
import logolight from "../../assets/images/QuicksliverLight.png";
                    ...
                    <Row className="justify-content-center">
                        <Col md={8} lg={6} xl={5}>
                            <div className="text-center mb-4">
                                ...
                                <h4 className = "">{t('Sign Up')}</h4>
                                <p className=" mb-4">{t('Get your Quicksliver account now')}.</p>
                            ...
                            <div className="mt-5 text-center">
                                <p>{t('Already have an account')}? <Link to="/login" className="font-weight-medium  "> {t('Sign In')} </Link> </p>
                            </div>
                        </Col>
                    </Row>
                </Container>
