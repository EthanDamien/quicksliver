                    ...
                    <Row className="justify-content-center">
                        <Col md={8} lg={6} xl={5} >
                            <div className="text-center mb-4">
                                ...
                                <p className="mb-4 ">{t('Sign in to continue to Quicksliver')}.</p>
                            ...
                            <div className="mt-5 text-center">
                                <p className = "">{t("Don't have an account")} ? <Link to="register" className="font-weight-medium  "> {t('Sign Up Now')} </Link> </p>
                            </div>
                        </Col>
                    </Row>
                </Container>
