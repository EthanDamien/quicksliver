                    ...
                    <Row className="justify-content-center">
                        <Col md={8} lg={6} xl={5}>
                            <div className="text-center mb-4">
                                ...
                                <p className="text-muted mb-4">{t('Reset Password With Quicksliver.')}</p>
                            ...
                            <div className="mt-5 text-center">
                                <p>{t('Remember It')} ? <Link to="login" className="font-weight-medium text-primary"> {t('Sign In')} </Link> </p>
                            </div>
                        </Col>
                    </Row>
                </Container>
